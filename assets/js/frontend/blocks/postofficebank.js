...
(() => {
/*!***********************************************************!*\
  !*** ./src/jp4wc/frontend/blocks/postofficebank/index.js ***!
  \***********************************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getSetting)('postofficebank_data', {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Postal transfer', 'woocommerce-for-japan');
const label = (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.title) || defaultLabel;
/**
 * Content component
 */
const Content = () => {
  return (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_2__.decodeEntities)(settings.description || '');
};
/**
 * Label component
 *
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(PostOfficeBank);
})();

/******/ })()
;
//# sourceMappingURL=postofficebank.js.map