...
$PEACHPAY_TRANSLATED_MODAL_TERMS = array(
    'de-DE' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Hinweis: Zahlungen dauern in der Regel 5 Tage.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Diese Zahlungsmethode unterstützt die von Ihnen gewählte Währung nicht. Der Händler hat ausgewählt",
        "Total" => "Gesamt",
        ...
        "apply" => "anwenden",
        "each" => "jeder",
        "for cases like these." => "für solche Fälle.",
    ...
    'es-ES' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Nota: Los pagos suelen tardar 5 días en completarse.",
        "Order notes" => "Pedidos",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Este método de pago no admite la moneda que ha elegido. El comerciante ha seleccionado",
        "Total" => "Total",
        ...
        "apply" => "aplicar",
        "each" => "cada",
        "for cases like these." => "para casos como estos.",
    ...
    'fr-FR' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Remarque : Les paiements prennent généralement 5 jours pour être effectués.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Ce mode de paiement ne prend pas en charge la devise que vous avez choisie. Le commerçant a sélectionné",
        "Total" => "Coûte",
        ...
        "apply" => "appliquer",
        "each" => "chaque",
        "for cases like these." => "pour des cas comme ceux-ci.",
        "iDEAL Bank" => "Banque idéale",
        "is not available for checkout" => "n'est pas disponible pour le paiement",
    ...
    'it' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Nota: i pagamenti in genere richiedono 5 giorni per essere completati.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Questo metodo di pagamento non supporta la valuta che hai scelto. Il commerciante ha selezionato",
        "Total" => "Totale",
        ...
        "apply" => "applicare",
        "each" => "a testa",
        "for cases like these." => "per casi come questi.",
    ...
    'ja' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "注: 支払いが完了するまでには通常 5 日かかります。",
        "Order notes" => "注文メモ",
        "Order summary" => "注文の概要",
        "PAYMENT" => "支払い",
        "Password" => "パスワード",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "この支払い方法は、選択した通貨をサポートしていません。販売者が選択したのは、",
        "Total" => "合計",
        ...
        "apply" => "申し込み",
        "each" => "各",
        "for cases like these." => "このような場合に。",
        "iDEAL Bank" => "理想の銀行",
        "is not available for checkout" => "チェックアウトできません",
        "privacy policy" => "プライバシーポリシー",
        "pursuant to" => "に従って",
    ...
    'ro-RO' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Notă: plățile durează de obicei 5 zile.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Această metodă de plată nu acceptă moneda pe care ați ales-o. Comerciantul a selectat",
        "Total" => "Total",
        ...
        "apply" => "aplica",
        "each" => "fiecare",
        "for cases like these." => "pentru cazuri ca acestea.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'ar' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "ملاحظة: عادةً ما يستغرق استكمال الدفعات 5 أيام.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "طريقة الدفع هذه لا تدعم العملة التي اخترتها. اختار التاجر",
        "Total" => "المجموع",
        ...
        "apply" => "يتقدم",
        "each" => "كل",
        "for cases like these." => "لحالات مثل هذه.",
    ...
    'ca' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Nota: els pagaments solen tardar 5 dies a completar-se.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Aquest mètode de pagament no admet la moneda que heu escollit. El comerciant ha seleccionat",
        "Total" => "Total",
        ...
        "apply" => "aplicar",
        "each" => "cadascun",
        "for cases like these." => "per a casos com aquests.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'cs-CZ' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Poznámka: Platby obvykle trvají 5 dní.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Tato platební metoda nepodporuje měnu, kterou jste zvolili. Obchodník vybral",
        "Total" => "Celkový",
        ...
        "apply" => "aplikovat",
        "each" => "každý",
        "for cases like these." => "pro takové případy.",
    ...
    'da-DK' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Bemærk: Betalinger tager typisk 5 dage at gennemføre.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Denne betalingsmetode understøtter ikke den valuta, du har valgt. Købmanden har valgt",
        "Total" => "i alt",
        ...
        "apply" => "ansøge",
        "each" => "hver",
        "for cases like these." => "for sager som disse.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'el' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Σημείωση: Οι πληρωμές χρειάζονται συνήθως 5 ημέρες για να ολοκληρωθούν.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Αυτός ο τρόπος πληρωμής δεν υποστηρίζει το νόμισμα που επιλέξατε. Ο έμπορος έχει επιλέξει",
        "Total" => "Σύνολο",
        ...
        "apply" => "ισχύουν",
        "each" => "καθε",
        "for cases like these." => "για περιπτώσεις σαν αυτές.",
    ...
    'hi-IN' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "नोट: भुगतान आमतौर पर पूरा होने में 5 दिन लगते हैं।",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "यह भुगतान विधि आपके द्वारा चुनी गई मुद्रा का समर्थन नहीं करती है। व्यापारी ने चुना है",
        "Total" => "कुल",
        ...
        "apply" => "लागू",
        "each" => "प्रत्येक",
        "for cases like these." => "ऐसे मामलों के लिए।",
    ...
    'ko-KR' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "참고: 결제가 완료되는 데 일반적으로 5일이 소요됩니다.",
        "Order notes" => "주문 메모",
        "Order summary" => "주문 요약",
        "PAYMENT" => "지불",
        "Password" => "비밀번호",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "이 결제 수단은 선택한 통화를 지원하지 않습니다. 판매자가 선택한",
        "Total" => "총",
    ...
    'lb-LU' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Notiz: Bezuelungen daueren normalerweis 5 Deeg fir ze kompletéieren.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Dës Bezuelmethod ënnerstëtzt net d'Währung déi Dir gewielt hutt. Den Händler huet gewielt",
        "Total" => "Ganzen",
        ...
        "apply" => "gëllen",
        "each" => "jeweils",
        "for cases like these." => "fir Fäll wéi dës.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'nl-NL' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Opmerking: het duurt doorgaans 5 dagen voordat betalingen zijn voltooid.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Deze betaalmethode ondersteunt de door u gekozen valuta niet. De handelaar heeft geselecteerd",
        "Total" => "Totaal",
        ...
        "each" => "elk",
        "for cases like these." => "voor gevallen als deze.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'pt-PT' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Observação: os pagamentos geralmente levam 5 dias para serem concluídos.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Este método de pagamento não suporta a moeda que você escolheu. O comerciante selecionou",
        "Total" => "Total",
        ...
        "apply" => "Aplique",
        "each" => "cada",
        "for cases like these." => "para casos como estes.",
        "iDEAL Bank" => "Banco ideal",
    ...
    'ru-RU' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Примечание. Платежи обычно занимают 5 дней.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Этот способ оплаты не поддерживает выбранную вами валюту. Продавец выбрал",
        "Total" => "Общее",
        ...
        "each" => "каждый",
        "for cases like these." => "для подобных случаев.",
    ...
    'sl-SI' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Opomba: plačila običajno trajajo 5 dni.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Ta način plačila ne podpira valute, ki ste jo izbrali. Trgovec je izbral",
        "Total" => "Skupaj",
        ...
        "apply" => "uporabiti",
        "each" => "vsak",
        "for cases like these." => "za take primere.",
    ...
    'sv-SE' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Obs! Betalningar tar vanligtvis 5 dagar att slutföra.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Denna betalningsmetod stöder inte den valuta du har valt. Säljaren har valt",
        "Total" => "Total",
        ...
        "apply" => "tillämpa",
        "each" => "varje",
        "for cases like these." => "för fall som dessa.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'th' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "หมายเหตุ: โดยทั่วไปการชำระเงินจะใช้เวลา 5 วันจึงจะเสร็จสมบูรณ์",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "วิธีการชำระเงินนี้ไม่รองรับสกุลเงินที่คุณเลือก แม่ค้าเลือกแล้ว",
        "Total" => "ทั้งหมด",
        ...
        "apply" => "นำมาใช้",
        "each" => "แต่ละ",
        "for cases like these." => "สำหรับกรณีเช่นนี้",
    ...
    'uk' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Примітка. Платежі зазвичай виконуються протягом 5 днів.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Цей спосіб оплати не підтримує вибрану вами валюту. Продавець вибрав",
        "Total" => "Всього",
        ...
        "apply" => "застосувати",
        "each" => "кожен",
        "for cases like these." => "для таких випадків.",
    ...
    'zh-CN' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "注意：付款通常需要 5 天才能完成。",
        "Order notes" => "订单备注",
        "Order summary" => "订单摘要",
        "PAYMENT" => "支付",
        "Password" => "密码",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "此付款方式不支持您选择的货币。商家已选择",
        "Total" => "全部的",
        ...
        "apply" => "申请",
        "each" => "每个",
        "for cases like these." => "对于这样的情况。",
        "iDEAL Bank" => "理想银行",
        "is not available for checkout" => "无法结帐",
        "privacy policy" => "隐私政策",
        "pursuant to" => "根据",
    ...
    'zh-TW' => array(
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "此付款方式不支持您選擇的貨幣。商家已選擇",
        "Total" => "全部的",
        ...
        "apply" => "申請",
        "each" => "每個",
        "for cases like these." => "對於這樣的情況。",
        "iDEAL Bank" => "理想銀行",
        "is not available for checkout" => "無法結帳",
        "privacy policy" => "隱私政策",
        "pursuant to" => "根據",
    ...
    'bg-BG' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Забележка: Плащанията обикновено отнемат 5 дни.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Този метод на плащане не поддържа валутата, която сте избрали. Търговецът е избрал",
        "Total" => "Обща сума",
        ...
        "apply" => "Приложи",
        "each" => "всеки",
        "for cases like these." => "за случаи като тези.",
        "iDEAL Bank" => "iDEAL Bank",
    ...
    'bs-BA' => array(
        ...
        "Note: Payments typically take 5 days to complete." => "Napomena: za isplate je obično potrebno 5 dana.",
        ...
        "This payment method does not support the currency you have chosen. The merchant has selected" => "Ovaj način plaćanja ne podržava valutu koju ste odabrali. Trgovac je odabrao",
        ...
        "apply" => "primijeniti",
        "each" => "svaki",
        "for cases like these." => "za ovakve slučajeve.",
        "iDEAL Bank" => "iDEAL banka",
