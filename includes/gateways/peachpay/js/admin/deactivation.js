...
function deactivationPopup() {
	...
	function showModal(event) {
		...
		const $modalContent = `
			<div id = "modal-content" class = "modal-content">
				<div id = "modal-header" class = "modal-header">
					...
					<span id = "deactivation-header" class = "deactivation-header"> Feedback </span>
				</div>
					...
					<form id = "peachpay-deactivate-feedback-form" method = "post" enctype = "multipart/form-data" >
						...
						<div id = "peachpay-deactivate-feedback-form-wrapper" class = "peachpay-deactivate-feedback-form-wrapper">
							...
							<div id = "peachpay-deactivate-feedback-input-wrapper" class = "feedback-input">
								...
								<label class = "peachpay-deactivate-feedback-label">
								I couldn't get the plugin to work</label>
								...
								height = "20" width = "20">
								<span class = "customer-support-ask"> Did you try contacting support via email or the</span>
								<a href = "${supportLink}" class = "customer-support-ask">customer support feature</a> 
							...
							<div id = "peachpay-deactivate-feedback-input-wrapper" class = "feedback-input">
								...
								<label class = "peachpay-deactivate-feedback-label">
								It's a temporary deactivation</label>
							</div>
							<div id = "peachpay-deactivate-feedback-input-wrapper" class = "feedback-input">
				...
				<div class = "modal-buttons-wrapper">
					...
					class="feedback-button-submit" name = "form_submit">
						...
						<div id = "pp-deactivate-content"> Submit & Deactivate </div>
					</button>
					<a href = ${deactivationLink} class="feedback-button-skip"> Skip & Deactivate </a>
				</div>
			</div>`;
		...
		$form.addEventListener('submit', async event => {
			...
			await fetch(`${basePeachPayAPIURL(location.hostname, deactivation_php_data.test_mode)}/api/v1/analytics/plugin-deactivation`,
				{
					method: 'POST',
					body: formData,
				});
