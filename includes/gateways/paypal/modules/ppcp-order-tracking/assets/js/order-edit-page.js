( () => {
	var t = {
			...
			408: ( t, r, e ) => {
				...
				t.exports = function ( t, r, e ) {
					var h,
						...
						k = n( r, O ),
						A = function ( t ) {
							return h && l( h, 'normal', t ), new y( ! 0, t );
						},
						C = function ( t ) {
							return j
								? ( i( t ),
			...
			1656: ( t, r, e ) => {
				...
				t.exports = function ( t, r, e, a, y, h, T ) {
					u( e, r, a );
					var P,
						k,
						A,
						...
						L = ! 1,
						I = t.prototype,
						_ = I[ S ] || I[ '@@iterator' ] || ( y && I[ y ] ),
						F = ( ! x && _ ) || C( y ),
						N = ( 'Array' == r && I.entries ) || _;
					if (
						( N &&
							( P = s( N.call( new t() ) ) ) !==
								Object.prototype &&
						...
						if (
							...
							for ( A in k )
								( x || L || ! ( A in I ) ) && v( I, A, k[ A ] );
						else n( { target: r, proto: ! 0, forced: x || L }, k );
					return (
						( i && ! T ) ||
							I[ S ] === F ||
							v( I, S, F, { name: y } ),
			...
			4032: ( t, r, e ) => {
				...
				var n = e( 2109 ),
					...
					ot = function ( t, r ) {
						var e = ( Z[ t ] = g( z ) );
						return (
							B( e, { type: U, tag: t, description: r } ),
							u || ( e.description = r ),
							e
						);
					},
		...
		( () => {
			...
			e( 1539 ),
				...
				document.addEventListener( 'DOMContentLoaded', function () {
					var r = PayPalCommerceGatewayOrderTrackingInfo;
					'undefined' ==
						typeof PayPalCommerceGatewayOrderTrackingInfo ||
					t( PayPalCommerceGatewayOrderTrackingInfo )
						? jQuery( document ).on(
								'click',
								'.submit_tracking_info',
								function () {
									var t = document.querySelector(
											'.ppcp-tracking-transaction_id'
										),
										e = document.querySelector(
											'.ppcp-tracking-tracking_number'
										),
										n = document.querySelector(
											'.ppcp-tracking-status'
										),
										o = document.querySelector(
											'.ppcp-tracking-carrier'
										),
										i =
									...
									a.setAttribute( 'disabled', 'disabled' ),
										fetch( r.ajax.tracking_info.endpoint, {
											method: 'POST',
											headers: {
												'Content-Type':
													'application/json',
											...
											body: JSON.stringify( {
												...
												tracking_number: e
													? e.value
													: null,
												status: n ? n.value : null,
												carrier: o ? o.value : null,
												order_id: i ? i.value : null,
												action: a
													? a.dataset.action
													: null,
											} ),
											...
											.then( function ( t ) {
												if ( ! t.success )
													throw (
														( jQuery(
															"<span class='error tracking-info-message'>" +
																t.data.message +
																'</span>'
														).insertAfter( a ),
														setTimeout(
												...
												jQuery(
													"<span class='success tracking-info-message'>" +
														t.data.message +
														'</span>'
												).insertAfter( a ),
													setTimeout( function () {
