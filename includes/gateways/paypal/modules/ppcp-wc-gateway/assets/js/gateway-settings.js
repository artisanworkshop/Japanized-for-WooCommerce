		...
		( () => {
			...
			function e( e, r ) {
				...
				var a = ( function ( t ) {
						...
						t.sdkBaseURL &&
							( ( e = t.sdkBaseURL ), delete t.sdkBaseURL ),
							( function ( t ) {
								var e = t[ 'merchant-id' ],
									r = t[ 'data-merchant-id' ],
									n = '',
									o = '';
								Array.isArray( e )
									? e.length > 1
				...
				return ( function ( e, r ) {
					...
					var o = t( e, r ),
						i = n.cloneNode();
					if (
						( delete i.dataset.uidAuto,
						Object.keys( i.dataset ).length !==
							Object.keys( o.dataset ).length )
					)
						return null;
					var a = ! 0;
					return (
						Object.keys( i.dataset ).forEach( function ( t ) {
							i.dataset[ t ] !== o.dataset[ t ] && ( a = ! 1 );
						} ),
						a ? n : null
					);
				} )( c, u ) && l
					...
					: ( function ( e, r ) {
					  ...
					  } )( { url: c, attributes: u }, r ).then( function () {
							var t = o( s );
							if ( t ) return t;
							throw new Error(
								'The window.'.concat(
			...
			const s = ( t, e, r ) => {
				...
				n && ( e ? n.classList.remove( r ) : n.classList.add( r ) );
			};
			document.addEventListener( 'DOMContentLoaded', function () {
				document
					.querySelectorAll( '.ppcp-disabled-checkbox' )
					.forEach( function ( t ) {
						return t.setAttribute( 'disabled', 'true' );
					} );
				var t = jQuery( '#mainform' ),
				...
				if ( r ) {
					...
					r.checked || n.classList.add( 'disabled' ),
						r.classList.contains( 'ppcp-disabled-checkbox' ) &&
				...
				function i( t ) {
					f( t, function ( t ) {
						var e = document.querySelector( t.button.wrapper );
						if ( e ) {
							e.innerHTML = '';
							var r = new ( class {
								constructor( t, e, r, n ) {
									( this.defaultSettings = e ),
										...
										( this.onSmartButtonClick = r ),
										( this.onSmartButtonsInit = n ),
										( this.renderedSources = new Set() );
								}
								render( t, e = {} ) {
									const r = u()( this.defaultSettings, e ),
									...
									if ( o )
										for ( const e of paypal
											.getFundingSources()
											.filter( ( t ) => ! ( t in n ) ) ) {
											let n = r.button.style;
											'paypal' !== e &&
												( ( n = {
													shape: n.shape,
													color: n.color,
								...
								renderButtons( t, e, r, n, o = null ) {
									if (
										! document.querySelector( t ) ||
										this.isAlreadyRendered( t, o, n ) ||
										void 0 === paypal.Buttons
									)
										return;
									o && ( r.fundingSource = o );
									const i = paypal.Buttons( {
										style: e,
										...r,
				...
				function c() {
					var t,
						e,
						n = jQuery( '[name="ppcp[disable_funding][]"]' ),
						o =
							n.length > 0
								? n.val()
								: PayPalCommerceGatewaySettings.disabled_sources,
						i = jQuery( '#ppcpPayLaterButtonPreview' ),
						a = {
							'client-id':
								PayPalCommerceGatewaySettings.client_id,
							currency: PayPalCommerceGatewaySettings.currency,
							'integration-date':
								PayPalCommerceGatewaySettings.integration_date,
							components: [
								'buttons',
								'funding-eligibility',
								'messages',
					...
					return (
						'sandbox' ===
							PayPalCommerceGatewaySettings.environment &&
							( a[ 'buyer-country' ] =
								PayPalCommerceGatewaySettings.country ),
						null != i &&
							i.length &&
							( o = Object.keys(
						...
						( r && e
							? r.checked && e.selectedOptions.length > 0
							: PayPalCommerceGatewaySettings.is_pay_later_button_enabled ) ||
							( o = o.concat( 'credit' ) ),
						null !== ( t = o ) &&
							void 0 !== t &&
							t.length &&
				...
				if (
					( o &&
						o.addEventListener( 'change', function () {
							s( '#field-button_layout', ! o.checked, 'hide' ),
								s(
					...
					[
						...
						var e = document.querySelector( t.layoutSelector ),
							r = document.querySelector( t.taglineSelector );
						if ( e && r ) {
							var n = function () {
								var n,
									i =
										'horizontal' === jQuery( e ).val() &&
										( ! t.canHaveSeparateButtons ||
											( o && ! o.checked ) ) &&
										!! (
											( n = e.parentElement )
												.offsetWidth ||
					...
					document.querySelectorAll( '.ppcp-preview' ).length )
				) {
					var p = c();
					t.on(
						'change',
						...
						a( function () {
							var t = c();
							JSON.stringify( p ) !== JSON.stringify( t ) &&
								( l( t ), ( p = t ) );
						}, 1e3 )
					),
						l( p, function () {
							[
								...
								[
									...
									var e = '#ppcp-pay_later_' + t + '_message',
										r =
											t.charAt( 0 ).toUpperCase() +
											t.slice( 1 );
									f(
