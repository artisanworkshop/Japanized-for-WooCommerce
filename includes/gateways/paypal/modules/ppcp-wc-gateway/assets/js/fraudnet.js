				...
				window.addEventListener( 'load', function () {
					function t() {
						...
						t && t.parentNode && t.parentNode.removeChild( t ),
							( ( t = document.createElement( 'script' ) ).id =
								'fconfig' ),
						...
						var r = { f: FraudNetConfig.f, s: FraudNetConfig.s };
						'1' === FraudNetConfig.sandbox && ( r.sandbox = ! 0 ),
							( t.text = JSON.stringify( r ) ),
							document.body.appendChild( t );
						var e = document.forms.order_review;
						if ( e ) {
							...
							n.setAttribute( 'type', 'hidden' ),
								...
								n.setAttribute( 'value', FraudNetConfig.f ),
								e.appendChild( n );
						}
						! ( function ( t ) {
							var r = document.createElement( 'script' );
							( r.src = 'https://c.paypal.com/da/r/fb.js' ),
					...
					document.addEventListener(
						...
						function ( r ) {
							PAYPAL.asyncData &&
								'function' ==
									typeof PAYPAL.asyncData.initAndCollect &&
