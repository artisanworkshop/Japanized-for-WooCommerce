	...
	var t = {
			...
			1223: ( t, r, e ) => {
				var n = e( 5112 ),
					...
					u = Array.prototype;
				null == u[ a ] &&
					i( u, a, { configurable: ! 0, value: o( null ) } ),
					( t.exports = function ( t ) {
						u[ a ][ t ] = ! 0;
					} );
			},
			...
			1656: ( t, r, e ) => {
				...
				t.exports = function ( t, r, e, a, d, h, T ) {
					c( e, r, a );
					var P,
						R,
						A,
						...
						k = ! 1,
						L = t.prototype,
						M = L[ S ] || L[ '@@iterator' ] || ( d && L[ d ] ),
						F = ( ! m && M ) || I( d ),
						N = ( 'Array' == r && L.entries ) || M;
					if (
						( N &&
							( P = s( N.call( new t() ) ) ) !==
								Object.prototype &&
						...
						if (
							...
							for ( A in R )
								( m || k || ! ( A in L ) ) && v( L, A, R[ A ] );
						else n( { target: r, proto: ! 0, forced: m || k }, R );
					return (
						( i && ! T ) ||
							L[ S ] === F ||
							v( L, S, F, { name: d } ),
				...
				( x && m ) ||
					...
					b
						...
						: u.addEventListener &&
						  ...
						  'file:' !== n.protocol &&
						  ! l( C )
						? ( ( o = C ), u.addEventListener( 'message', I, ! 1 ) )
						: ( o =
						...
						var j = n( 'Error' ),
							E = r( function ( t, r ) {
								...
								return (
									...
									d && i( n, 'stack', v( n.stack, 2 ) ),
									this && a( O, this ) && f( n, this, E ),
									arguments.length > x &&
										l( n, arguments[ x ] ),
									n
								);
			...
			3401: ( t, r, e ) => {
				...
				var n,
					...
					G = R.f,
					B = G,
					V = !! ( U && U.createEvent && s.dispatchEvent ),
							...
							function ( t, o ) {
								...
								for (
									...
									if ( d ) {
										var _ = w( [ k ], M, L, u );
										void 0 !== N && O( _, N );
										var D = v( n( o, void 0, _ ) );
									} else D = g( k, u, L, M, N, o );
									L >= I &&
										( ( A += E( u, I, L ) + D ),
										( I = L + k.length ) );
								}
			...
			1817: ( t, r, e ) => {
				...
				if (
					o &&
					c( v ) &&
					( ! ( 'description' in d ) || void 0 !== v().description )
				) {
					var y = {},
						h = function () {
							var t =
					...
					l( h, v ), ( h.prototype = d ), ( d.constructor = h );
		...
		( () => {
			...
			e( 1539 ),
				...
				document.addEventListener( 'DOMContentLoaded', function () {
					var r,
						e = PayPalCommerceGatewayClearDb;
					if ( t( e ) ) {
						var n = e.clearDb;
						null === ( r = document.querySelector( n.button ) ) ||
							void 0 === r ||
							r.addEventListener( 'click', function () {
								if ( confirm( n.confirmationMessage ) ) {
									var t = document.querySelector( n.button );
