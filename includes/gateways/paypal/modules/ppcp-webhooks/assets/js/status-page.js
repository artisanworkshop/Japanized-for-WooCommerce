/*! For license information please see status-page.js.LICENSE.txt */
( () => {
	var t = {
			9662: ( t, r, e ) => {
				var n = e( 614 ),
			...
			1656: ( t, r, e ) => {
				...
				t.exports = function ( t, r, e, a, h, d, P ) {
					...
					var k,
						...
						R = ! 1,
						_ = t.prototype,
						N = _[ w ] || _[ '@@iterator' ] || ( h && _[ h ] ),
						I = ( ! x && N ) || C( h ),
						F = ( 'Array' == r && _.entries ) || N;
					if (
						( F &&
							( k = s( F.call( new t() ) ) ) !==
								Object.prototype &&
						...
						if (
							...
							for ( L in T )
								( x || R || ! ( L in _ ) ) && v( _, L, T[ L ] );
						else n( { target: r, proto: ! 0, forced: x || R }, T );
					return (
						( i && ! P ) ||
							_[ w ] === I ||
							v( _, w, I, { name: h } ),
				...
				( b && x ) ||
					...
					g
						...
						: c.addEventListener &&
						  ...
						  'file:' !== n.protocol &&
						  ! l( A )
						? ( ( o = A ), c.addEventListener( 'message', C, ! 1 ) )
						: ( o =
			...
			9191: ( t, r, e ) => {
				...
				t.exports = function ( t, r, e, m ) {
					...
					if ( S ) {
						var O = S.prototype;
						if ( ( ! d && o( O, 'cause' ) && delete O.cause, ! e ) )
							return S;
						var j = n( 'Error' ),
							E = r( function ( t, r ) {
			...
			3401: ( t, r, e ) => {
				...
				var n,
					...
					U = T.f,
					B = U,
					V = !! ( D && D.createEvent && s.dispatchEvent ),
					z = 'unhandledrejection',
					J = function ( t ) {
						var r;
						return ! ( ! m( t ) || ! d( ( r = t.then ) ) ) && r;
					},
					q = function ( t, r ) {
						var e,
							n,
				...
				if (
					...
					} ).prototype = p( G, 'then', function ( t, r ) {
						var e = _( this ),
							n = U( b( this, F ) );
						return (
							( e.parent = ! 0 ),
			...
			4032: ( t, r, e ) => {
				...
				var n = e( 2109 ),
					...
					ot = function ( t, r ) {
						var e = ( Z[ t ] = g( J ) );
						return (
							U( e, { type: W, tag: t, description: r } ),
							u || ( e.description = r ),
							e
						);
					},
	...
	( e.g = ( function () {
		...
		( () => {
			...
			function r() {
				...
				var b = ( y.prototype = v.prototype = Object.create( d ) );
				function x( t ) {
				...
				return (
					...
					s( b, 'constructor', y ),
					s( y, 'constructor', h ),
					( h.displayName = s( y, u, 'GeneratorFunction' ) ),
			...
			document.addEventListener( 'DOMContentLoaded', function () {
												...
												return (
													...
													fetch(
															...
															.endpoint,
														{
															...
															body: JSON.stringify(
																{
																	nonce: PayPalCommerceGatewayWebhooksStatus
																		.resubscribe
																		.nonce,
																}
															),
				...
				var i = document.querySelector( '#ppcp-sandbox_on' );
				if ( i ) {
					var a = function ( t ) {
							[
						...
						c =
							'sandbox' ===
							PayPalCommerceGatewayWebhooksStatus.environment;
					a( c === i.checked ),
