/*! For license information please see myaccount-payments.js.LICENSE.txt */
( () => {
	var t = {
			9662: ( t, r, e ) => {
				var n = e( 614 ),
				...
				t.exports = function ( t, r, e, a, h, d, P ) {
					...
					if (
						...
						if (
							...
							for ( A in L )
								( x || C || ! ( A in _ ) ) && v( _, A, L[ A ] );
						else n( { target: r, proto: ! 0, forced: x || C }, L );
					return (
						( i && ! P ) ||
							_[ w ] === N ||
							v( _, w, N, { name: h } ),
				...
				( b && x ) ||
					...
					m
						...
						: c.addEventListener &&
						  ...
						  'file:' !== n.protocol &&
						  ! l( R )
						? ( ( o = R ), c.addEventListener( 'message', k, ! 1 ) )
						: ( o =
		...
		( () => {
			...
			e( 1539 ),
				...
				document.addEventListener( 'DOMContentLoaded', function () {
					jQuery( '.ppcp-delete-payment-button' ).click(
						( function () {
							var t,
								e =
															...
															return (
																...
																fetch(
																		...
																		.endpoint,
																	{
																		...
																		body: JSON.stringify(
																			{
																				nonce: PayPalCommerceGatewayVaulting
																					.delete
																					.nonce,
																				token: n,
																			}
...
//# sourceMappingURL=myaccount-payments.js.map
