<?php
/**
 * Japanized for WooCommerce Usage Tracking Class
 *
 * The Japanized for WooCommerce tracker class adds functionality to track WooCommerce usage based on if the customer opted in.
...
if ( class_exists( 'Automattic\WooCommerce\Internal\DataStores\Orders\OrdersTableDataStore' ) && ! class_exists( 'JP4WC_Usage_Tracking', false ) ) :
	/**
	 * Japanized for WooCommerce Usage Tracking Class
	 */
	class JP4WC_Usage_Tracking {
		 ...
		 * @var string
		 */
		private static $api_url = 'https://wc.artws.info/wp-json/jp4wc/v1/tracking/';
		 ...
		 */
		public static function jp4wc_send_tracking_data( $override = false ) {
		...
		private static function get_last_send_time() {
			 ...
			 * @since 2.3.0
			 */
			return apply_filters( 'jp4wc_tracker_last_send_time', get_option( 'jp4wc_tracker_last_send', false ) );
		}
		...
		public static function get_tracking_data() {
			 ...
			 * @since 2.3.0
			 */
			return apply_filters( 'jp4wc_tracker_data', $data );
		}
